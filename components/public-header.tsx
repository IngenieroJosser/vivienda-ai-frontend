      ...
      <header className="sticky top-0 z-50 border-b border-black/[.06] bg-[#fafafa]/90 backdrop-blur-xl">
        <div className="mx-auto flex h-[72px] max-w-[1500px] items-center justify-between px-5 sm:px-8 lg:px-12">
          ...
          <div className="hidden items-center gap-3 sm:flex">
            ...
            <Link href="/vivienda/inicio" prefetch className="inline-flex items-center gap-2 rounded-full bg-[#111] px-5 py-3 text-xs font-semibold text-white transition hover:bg-[#0067b1]">Comenzar <Icon name="arrow" className="h-4 w-4" /></Link>
          </div>
        ...
        {open ? (
          <div className="border-t border-black/[.06] bg-white px-5 py-5 sm:hidden">
            <nav className="flex flex-col gap-2">
              ...
              <Link href="/vivienda/inicio" prefetch className="mt-2 rounded-2xl bg-[#0067b1] px-4 py-3 text-center text-sm font-semibold text-white">Comenzar evaluación</Link>
            </nav>
          </div>
        ) : null}
      </header>
    ...
    <header className="sticky top-0 z-50 border-b border-black/[.065] bg-white/92 shadow-[0_6px_24px_rgba(17,24,32,.035)] backdrop-blur-xl">
      <div className="mx-auto flex h-[76px] max-w-[1500px] items-center justify-between px-5 sm:px-8 lg:px-12">
        ...
        <div className="hidden items-center gap-2 sm:flex">
          ...
          <Link href="/vivienda/inicio" prefetch className="inline-flex h-10 items-center gap-2 rounded-full bg-[#0067b1] px-5 text-xs font-semibold text-white shadow-[0_10px_26px_rgba(0,103,177,.18)] transition hover:-translate-y-0.5 hover:bg-[#005995]">
