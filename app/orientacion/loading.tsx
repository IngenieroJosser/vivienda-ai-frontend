  ...
  return (
    ...
    >
      ...
      <main className="mx-auto max-w-[760px] space-y-5 px-4 py-7 sm:px-6">
        <div className="h-20 w-[78%] animate-pulse rounded-[var(--vm-radius-card)] bg-white" />
        <div className="ml-auto h-16 w-[62%] animate-pulse rounded-[var(--vm-radius-card)] bg-[color:var(--vm-color-brand-blue)]/10" />
        <div className="h-24 w-[82%] animate-pulse rounded-[var(--vm-radius-card)] bg-white" />
      </main>
